 ...
 */
public class NoCheckedFragment extends Fragment implements RealmChangeListener<RealmResults<Board>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_no_checked, container, false);
        txtQuantity = (TextView) view.findViewById(R.id.txtQuantityNo);
        ...
        txtQuantity.setText("Te faltan "+ list.size()+" laminas.");

        recyclerView = view.findViewById(R.id.recyclerViewNo);
